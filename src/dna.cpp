...
DNA::DNA() noexcept
    : perception_radius(random_in_range(40, 100)),
      ...
      mutation_rate(0.1),
      reproduction_cost(random_in_range(5, 10.0)),
      malice_desire(random_in_range(0.01, 0.1)),
      ...
      malice_damage(random_in_range(0.8, 2.0)),
      altruism_heal(random_in_range(0.8, 2.0)),
